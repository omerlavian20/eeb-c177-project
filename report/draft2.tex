...
%look in paper to find specific/relevant change in behavior as a result of anthro change
...
\lstinputlisting[language=R, caption=Code for plots., breaklines=true]{graphcode.r}

\newpage

\begin{figure}
\caption{Comparison of FID measurements for native vs. urban juncos.}
\includegraphics[width=15cm, height=9 cm]{EEB-C177 LaTeX Work/Project/UrbanNativeFID.png}
\label{fid:UrbanNative}
\end{figure}[h]

\begin{figure}[h]
\caption{Linear model of relationship between initial observer distance and Euclidian FID.}
\includegraphics[width=15cm, height=9cm]{EEB-C177 LaTeX Work/Project/InitDistFID.png}
\label{fig:InitDist}
\end{figure}
